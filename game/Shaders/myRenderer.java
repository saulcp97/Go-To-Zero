...
public class myRenderer extends ModelBatch implements Disposable {
     ...
     * @author xoppa, badlogic */
        ...
        protected final myRenderer.RenderablePool renderablesPool = new RenderablePool();
        ...
        public myRenderer (final RenderContext context, final ShaderProvider shaderProvider, final RenderableSorter sorter) {
         ...
         * @param context The {@link RenderContext} to use.
         * @param shaderProvider The {@link ShaderProvider} to use, will be disposed when this ModelBatch is disposed. */
        public myRenderer (final RenderContext context, final ShaderProvider shaderProvider) {
         ...
         * @param context The {@link RenderContext} to use.
         * @param sorter The {@link RenderableSorter} to use. */
        public myRenderer (final RenderContext context, final RenderableSorter sorter) {
            this(context, null, sorter);
        }

        /** Construct a ModelBatch, using this constructor makes you responsible for calling context.begin() and context.end() yourself.
         * @param context The {@link RenderContext} to use. */
        public myRenderer (final RenderContext context) {
         ...
         * @param shaderProvider The {@link ShaderProvider} to use, will be disposed when this ModelBatch is disposed.
         * @param sorter The {@link RenderableSorter} to use. */
        public myRenderer (final ShaderProvider shaderProvider, final RenderableSorter sorter) {
            this(null, shaderProvider, sorter);
        }

        /** Construct a ModelBatch
         * @param sorter The {@link RenderableSorter} to use. */
        public myRenderer (final RenderableSorter sorter) {
            this(null, null, sorter);
        }

        /** Construct a ModelBatch
         * @param shaderProvider The {@link ShaderProvider} to use, will be disposed when this ModelBatch is disposed. */
        public myRenderer (final ShaderProvider shaderProvider) {
        ...
        public myRenderer (final FileHandle vertexShader, final FileHandle fragmentShader) {
