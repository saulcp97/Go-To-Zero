...
public class world {
    ...
    public void addHouse(int Type, int x, int y, int z){
        switch(Type){
            ...
            case 0:
                addToWorld(x - 10,y - 5,z,1);
                addToWorld(x - 10,y    ,z,1);
                addToWorld(x - 5 ,y - 5,z,1);
                addToWorld(x - 5 ,y    ,z,1);
                addToWorld(x     ,y - 5,z,1);
                addToWorld(x + 5 ,y - 5,z,1);
                addToWorld(x + 5 ,y    ,z,1);
             
                addToWorld(x - 10,y - 5,z + 5,1);
                addToWorld(x - 10,y    ,z + 5,1);
                addToWorld(x - 5 ,y - 5,z + 5,1);
                addToWorld(x - 5 ,y    ,z + 5,1);
                addToWorld(x     ,y - 5,z + 5,1);
                addToWorld(x     ,y    ,z + 5,1);
                addToWorld(x + 5 ,y - 5,z + 5,1);
                addToWorld(x + 5 ,y    ,z + 5,1);
                
                break;
            case 1:
                addToWorld(x - 10, y - 10, z, 1);
                addToWorld(x - 5 , y - 10, z, 1);
                addToWorld(x     , y - 10, z, 1);
                addToWorld(x + 5 , y - 10, z, 1);
                addToWorld(x + 10, y - 10, z, 1);
                ...
                addToWorld(x - 10, y - 10, z + 5, 1);
                addToWorld(x - 5 , y - 10, z + 5, 1);
                addToWorld(x     , y - 10, z + 5, 1);
                addToWorld(x + 5 , y - 10, z + 5, 1);
                addToWorld(x + 10, y - 10, z + 5, 1);
                addToWorld(x - 10, y - 5, z + 5, 1);
                addToWorld(x + 10, y - 5, z + 5, 1);
                ...
                addToWorld(x - 5, y - 5, z + 10,1);
                addToWorld(x    , y - 5, z + 10,1);
                addToWorld(x + 5, y - 5, z + 10,1);
                addToWorld(x - 5, y    , z + 10,1);
                addToWorld(x + 5, y    , z + 10,1);
                addToWorld(x - 5, y + 5, z + 10,1);
                addToWorld(x    , y + 5, z + 10,1);
                addToWorld(x + 5, y + 5, z + 10,1);
                
                addToWorld(x    , y, z + 15,1);
            ...
            case 1000000://Mansion  51 * 51 10
                ...
                addToWorld(x - 240, y - 10, z, 1);
                addToWorld(x - 235, y - 10, z, 1);
                addToWorld(x - 230, y - 10, z, 1);
                
                addToWorld(x + 230, y - 10, z, 1);
                addToWorld(x + 235, y - 10, z, 1);
                addToWorld(x + 240, y - 10, z, 1);
                
                addToWorld(x - 245, y - 5, z, 1);
                addToWorld(x - 225, y - 5, z, 1);
                
                addToWorld(x + 225, y - 5, z, 1);
                addToWorld(x + 245, y - 5, z, 1);
                
                addToWorld(x - 250, y, z, 1);
                addToWorld(x + 250, y, z, 1);
                
                
                for(int i = -44; i <= 44; ++i){
                    addToWorld(x + i*5, y /*- 250*/, z, 1);                
                }
                
                addToWorld(x - 250, y + 5, z, 1);
                addToWorld(x + 250, y + 5, z, 1);
                addToWorld(x - 250, y + 10, z, 1);
                addToWorld(x + 250, y + 10, z, 1);

                for(int i = -45; i <= 45; ++i){
                    addToWorld(x + i*5, y + 10, z, 1);                
                }
                
                addToWorld(x - 245, y + 15, z, 1);
                addToWorld(x - 230, y + 15, z, 1);
                addToWorld(x - 200, y + 15, z, 1);
                addToWorld(x + 200, y + 15, z, 1);
                addToWorld(x + 230, y + 15, z, 1);
                addToWorld(x + 245, y + 15, z, 1);
                
                addToWorld(x - 240, y + 20, z, 1);
                addToWorld(x - 230, y + 20, z, 1);
                addToWorld(x - 200, y + 20, z, 1);
                addToWorld(x + 200, y + 20, z, 1);
                addToWorld(x + 230, y + 20, z, 1);
                addToWorld(x + 240, y + 20, z, 1);
                
                for(int i = 0; i <= 25; ++i) {
                    addToWorld(x - 240, y + 20 + i*5, z, 1);
                    addToWorld(x - 230, y + 20 + i*5, z, 1);
                    addToWorld(x - 200, y + 20 + i*5, z, 1);
                    addToWorld(x + 200, y + 20 + i*5, z, 1);
                    addToWorld(x + 230, y + 20 + i*5, z, 1);
                    addToWorld(x + 240, y + 20 + i*5, z, 1);                    
                }
                addToWorld(x - 195, y + 145, z, 1);
                addToWorld(x + 195, y + 145, z, 1);
                
                addToWorld(x - 190, y + 145, z, 1);
                addToWorld(x + 190, y + 145, z, 1);
                
                addToWorld(x - 185, y + 145, z, 1);
                addToWorld(x + 185, y + 145, z, 1);
                
                addToWorld(x - 180, y + 145, z, 1);
                addToWorld(x + 180, y + 145, z, 1);
                
                addToWorld(x - 175, y + 145, z, 1);
                addToWorld(x + 175, y + 145, z, 1);
                
                
                addToWorld(x - 240, y + 150, z, 1);
                addToWorld(x - 230, y + 150, z, 1);
                addToWorld(x - 175, y + 150, z, 1);
                addToWorld(x + 175, y + 150, z, 1);
                addToWorld(x + 230, y + 150, z, 1);
                addToWorld(x + 240, y + 150, z, 1);
                
                addToWorld(x - 240, y + 155, z, 1);
                addToWorld(x - 230, y + 155, z, 1);
                addToWorld(x - 175, y + 155, z, 1);
                addToWorld(x + 175, y + 155, z, 1);
                addToWorld(x + 230, y + 155, z, 1);
                addToWorld(x + 240, y + 155, z, 1);
                
                addToWorld(x - 240, y + 160, z, 1);
                addToWorld(x - 230, y + 160, z, 1);
                addToWorld(x - 175, y + 160, z, 1);
                addToWorld(x + 175, y + 160, z, 1);
                addToWorld(x + 230, y + 160, z, 1);
                addToWorld(x + 240, y + 160, z, 1);
                
                addToWorld(x - 240, y + 165, z, 1);
                addToWorld(x - 230, y + 165, z, 1);
                addToWorld(x - 175, y + 165, z, 1);
                addToWorld(x + 175, y + 165, z, 1);
                addToWorld(x + 230, y + 165, z, 1);
                addToWorld(x + 240, y + 165, z, 1);
                ...
                addToWorld(x - 240, y + 170, z, 1);
                addToWorld(x - 230, y + 170, z, 1);
                
                addToWorld(x - 185, y + 170, z, 1);
                addToWorld(x - 180, y + 170, z, 1);
                addToWorld(x - 175, y + 170, z, 1); 
                addToWorld(x - 170, y + 170, z, 1);
                addToWorld(x - 165, y + 170, z, 1);
                ...
                addToWorld(x - 240, y + 175, z, 1);
                addToWorld(x - 230, y + 175, z, 1);
                
                addToWorld(x - 190, y + 175, z, 1);
                addToWorld(x - 160, y + 175, z, 1);
                ...
                addToWorld(x - 240, y + 180, z, 1);
                addToWorld(x - 230, y + 180, z, 1);
                
                addToWorld(x - 195, y + 180, z, 1);
                addToWorld(x - 155, y + 180, z, 1);
                ...
                addToWorld(x - 240, y + 185, z, 1);
                addToWorld(x - 230, y + 185, z, 1);
                
                addToWorld(x - 200, y + 185, z, 1);
                addToWorld(x - 150, y + 185, z, 1);
                ...
                addToWorld(x - 240, y + 190, z, 1);
                addToWorld(x - 230, y + 190, z, 1);
                
                addToWorld(x - 200, y + 190, z, 1);
                addToWorld(x - 150, y + 190, z, 1);
                ...
                addToWorld(x - 240, y + 195, z, 1);
                addToWorld(x - 230, y + 195, z, 1);
                
                addToWorld(x - 200, y + 195, z, 1);
                addToWorld(x - 150, y + 195, z, 1);
    ...
    public void addToWorld(int x, int y, int z, int Type) {
